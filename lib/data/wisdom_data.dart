class WisdomItem {
  ...
  const List<WisdomItem> wisdomList = [
    // 🌕 명절 (추석·설날)
    WisdomItem(
      id: 'w101',
      title: '보름달처럼 넉넉한 한가위',
    ...
    WisdomItem(
      id: 'w103',
      title: '새해 복 많이 받으세요',
      content: '다사다난했던 한 해가 저물고\n희망찬 새해가 밝았습니다.\n\n올 한 해도 늘 건강하시고,\n소망하시는 모든 일들이\n순조롭게 이루어지기를 진심으로 기원합니다.',
      author: '마음카드',
      category: '🌕 명절 (추석·설날)',
      emoji: '🌅',
      tags: ['#설날', '#새해인사', '#새해복많이받으세요'],
    ),
    WisdomItem(
      id: 'w104',
      title: '따뜻한 떡국 한 그릇처럼',
      content: '따뜻한 떡국 한 그릇에\n나이와 함께 지혜를 더해가는 새해입니다.\n\n언제나 당신의 가정에\n평안과 행복이 깃들기를 기도합니다.',
      author: '마음카드',
      category: '🌕 명절 (추석·설날)',
      emoji: '🍲',
      tags: ['#설날인사', '#떡국', '#행복기원'],
    ...
    WisdomItem(
      id: 'w105',
      title: '고마운 당신께 전하는 마음',
      content: '명절을 맞이하여\n소중한 당신께 안부를 전합니다.\n\n떨어져 있어도\n마음만은 언제나 곁에 있습니다.\n항상 건강하시고 행복하세요!',
      author: '마음카드',
      category: '🌕 명절 (추석·설날)',
      emoji: '💌',
      tags: ['#명절안부', '#감사인사', '#따뜻한마음'],
    ),
    WisdomItem(
      id: 'w106',
      title: '건강과 웃음이 넘치는 명절',
      content: '맛있는 명절 음식\n가족들과 오순도순 나누며\n건강하고 웃음 넘치는 시간 보내세요.\n\n올 한 해도\n좋은 일만 가득하시길 바랍니다.',
      author: '마음카드',
      category: '🌕 명절 (추석·설날)',
      emoji: '👨‍👩‍👧‍👦',
